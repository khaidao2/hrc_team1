...
_HERE = os.path.dirname(os.path.abspath(__file__))   # src/task1/
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--plans",
        default=os.path.join(_REPO_ROOT, "tests", "mock_action_plans.json"),
        help="Path to action plans JSON (default: tests/mock_action_plans.json)",
    )
    parser.add_argument(
        "--log-dir",
        default=os.path.join(_REPO_ROOT, "logs", "task1"),
        help="Output directory for all generated files (default: logs/task1/)",
    )
