...
DEFAULT_PARAMS: dict = {
    ...
    # Gripper (m, steps)
    "open_width_m":                 -0.0215,   # matches baseline gripper_open_width
    "close_width_m":                0.01,       # matches baseline gripper_close_width
    "min_grasp_width_m":            0.01,
    "max_grasp_width_m":            0.08,
    "open_wait_steps":              10,
    "close_wait_steps":             15,

    # Workspace limits (m) – Walker S2 baseline
    "workspace_x":                  [0.25, 0.70],
    "workspace_y":                  [-0.35, 0.35],
    "workspace_z":                  [0.70, 1.15],
